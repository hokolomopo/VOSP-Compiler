...
%7 = ptrtoint %class.Main* %6 to i64
%8 = inttoptr i64 %7 to %class.IO*
%9 = call %class.IO* @IO.print(%class.IO* %8, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0))
...
%11 = ptrtoint %class.Main* %10 to i64
%12 = inttoptr i64 %11 to %class.IO*
%13 = load %class.Y*, %class.Y** %1 
%14 = call %class.Y* @Y.getSelf(%class.Y* %13)
%15 = ptrtoint %class.Y* %14 to i64
%16 = inttoptr i64 %15 to %class.X*
%17 = call i32 @X.xfun(%class.X* %16)
%18 = call %class.IO* @IO.printInt32(%class.IO* %12, i32 %17)
store %class.IO* %18, %class.IO** %cond.ptr 
br label %cond.end

cond.end:
%19 = load %class.IO*, %class.IO** %cond.ptr 
ret i32 3 
}
...
store i32 %4, i32* %5 
%6 = getelementptr %class.Y, %class.Y* %self, i32 0, i32 0 
%7 = load i32, i32* %6 
ret i32 %7 
}

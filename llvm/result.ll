...
@.str = private unnamed_addr constant [21 x i8] c"Never to be printed\0a\00"
...
%2 = getelementptr %class.Main, %class.Main* %self, i32 0, i32 0 
%3 = load %class.X*, %class.X** %2 
%4 = call i32 @X.dontModifyIt(%class.X* %3, i32 45)
ret i32 0 
}
...
store %class.X* null, %class.X** %6 
ret %class.Main* %5
}

%class.X = type { i32 }

define i32 @X.modifyTheVar(%class.X* %self) {
...
%2 = getelementptr %class.X, %class.X* %self, i32 0, i32 0 
store i32 48, i32* %2 
ret i32 56 
}

define i32 @X.dontModifyIt(%class.X* %self, i32 %i) {
%1 = icmp eq %class.X* null, %self
br i1 %1, label %cond.true, label %cond.false
cond.true:
%testing = alloca [5 x i8]
store [5 x i8] c"test\00", [5 x i8]* %testing
%test = getelementptr inbounds [5 x i8], [5 x i8]* %testing, i32 0, i32 0
%unused = call i32 (i8*, ...) @printf(i8* %test)
call void @exit(i32 -1)
ret i32 0
...
%2 = load %class.X*, %class.X** %self.ptr 
%3 = ptrtoint %class.X* %2 to i64
%4 = inttoptr i64 %3 to %class.IO*
%5 = call %class.IO* @IO.print(%class.IO* %4, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0))
ret i32 3 
}
